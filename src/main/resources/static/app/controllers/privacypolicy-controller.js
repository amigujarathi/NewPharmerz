myApp.controller('PrivacypolicyCtrl', function($scope,$route,$location,$cookies,Page,baseURl,errorMessage,$http,sessionmaintain,getcategorydetails,ContextPath,$timeout){
    
    var vm = $scope;
    
    Page.setTitle('Privacy Policy'); // To set Page Title using factory
