myApp.controller('ProductCtrl', function($scope,$rootScope,$route,$location,$cookies,$cookieStore,$timeout,Page,baseURl,errorMessage,$http,sessionmaintain,getcategorydetails,ContextPath,$timeout){
...
*/ 
    ...
    //Code for no supplier for product
    vm.NoSupplier = $cookies.get('Nosupplier');
    //console.log("NoSupplier : " + vm.NoSupplier);

    if(vm.NoSupplier == 'true')
    {
        vm.ShowErrorNoSupplier = true;

        var reloadRoute = function() {
            vm.ShowErrorNoSupplier = false;
            $cookieStore.remove('Nosupplier');
        }

        $timeout(reloadRoute, 5000); // timeout
    }

    //Code for not verified user to send enquiry
    vm.NotVerified = $cookies.get('NotVerified');

    if(vm.NotVerified == 'true')
    {
        vm.ShowErrorNotVerifiedUser = true;

        var reloadRoute = function() {
            vm.ShowErrorNotVerifiedUser = false;
            $cookieStore.remove('NotVerified');
        }
     ...
     * Modified By  -
     * Modified On  -
     * Purpose      - This method is used to pagination.
     */
    // config file
    var getproductdtlconfig = {
        headers : {
            'Accept' : 'application/json',
            'Content-Type': 'application/json',
        }
    ...
    vm.pagination = function () {
        ...
        vm.loading = true;
         ...
         {
             console.log('first block 701');
             var Categoryid_Cookie = $cookies.get('Categoryid');
             //console.log('Categoryid_Cookie  : ' + Categoryid_Cookie);

             $http.get(ContextPath +'/api/v1/products/search/findByCategoryId?categoryId='+ Categoryid_Cookie, getproductdtlconfig)
                 .success(function (data, status) {

                    console.log('Cookies Product details first : ' + JSON.stringify(data));
         ...
         else if($cookies.get('ProductComposition'))
         {
             console.log('second block 737');
             var ProductComposition_Cookie = $cookies.get('ProductComposition');
             //console.log('ProductComposition_Cookie  : ' + ProductComposition_Cookie);

             $http.get(ContextPath +'/api/v1/products/search/findByComposition?composition='+ ProductComposition_Cookie, getproductdtlconfig)
                 .success(function (data, status) {
                     console.log('Product details second : ' + JSON.stringify(data));
                     ////console.log('Product details status : ' + status);
                     $cookieStore.remove('ProductComposition');
                     vm.loading = false;
         ...
         else if($cookies.get('ProductCategory') != 'ALLCat' && $cookies.get('ProductName'))
         {
             console.log('third block 771');
             var ProductCategory_Cookie = $cookies.get('ProductCategory');
             //console.log('ProductCategory_Cookie  : ' + ProductCategory_Cookie);
             var ProductName_Cookie = $cookies.get('ProductName');
             //console.log('ProductName_Cookie  : ' + ProductName_Cookie);

             //$http.get(ContextPath +'/api/v1/products/search/findByCategoryIdAndProductContaining?categoryId='+ ProductCategory_Cookie +'&product='+ ProductName_Cookie +'&projection=detail', getproductdtlconfig)

             $http.get(ContextPath +'/api/v1/products/search/findByCategoryIdAndProductContainingIgnoreCase?categoryId='+ ProductCategory_Cookie +'&product='+ ProductName_Cookie +'&projection=detail', getproductdtlconfig)
                 .success(function (data, status) {
                     console.log('Product details third : ' + JSON.stringify(data));
                     ////console.log('Product details status : ' + status);
                     //$cookieStore.remove('ProductCategory');
                     //$cookieStore.remove('ProductName');
                     vm.loading = false;
         ...
         else if($cookies.get('ProductCategory') == 'ALLCat' && $cookies.get('ProductName'))
         {
             ...
             $http.get(ContextPath +'/api/v1/products/search/findByProductContainingIgnoreCase?productId='+ ProductName_Cookie +'&projection=detail', getproductdtlconfig)
                 .success(function (data, status) {
                     console.log('Product details  fourth : ' + JSON.stringify(data));
                     ////console.log('Product details status : ' + status);
                     //$cookieStore.remove('ProductCategory');
                     //$cookieStore.remove('ProductName');
                     vm.loading = false;
         ...
         else if($cookies.get('Alphabet'))
         {
             console.log('fifth block 847');

             var Alphabet_Cookie = $cookies.get('Alphabet');
             //console.log('Alphabet_Cookie  : ' + Alphabet_Cookie);

             $http.get(ContextPath +'/api/v1/products/search/findByProductIsStartingWith?productId='+ Alphabet_Cookie, getproductdtlconfig)
                 .success(function (data, status) {
                     console.log('Product details fifth : ' + JSON.stringify(data));
                     ////console.log('Product details status : ' + status);
                     $cookieStore.remove('Alphabet');
                     vm.loading = false;
         ...
         else if($cookies.get('Digit'))
         {
             console.log('sixth block 883');
             var Digit_Cookie = $cookies.get('Digit');
             //console.log('Digit_Cookie  : ' + Digit_Cookie);

             $http.get(ContextPath +'/api/v1/products/search/findByProductIsStartingWith?productId='+ Digit_Cookie, getproductdtlconfig)
                 .success(function (data, status) {
                     console.log('Product details  sixth : ' + JSON.stringify(data));
                     ////console.log('Product details status : ' + status);
                     $cookieStore.remove('Digit');
                     vm.loading = false;
         ...
         {
             console.log('seventh block 917');

             $http.get(ContextPath +'/api/v1/products?page='+ vm.page, getproductdtlconfig)
                 .success(function (data, status) {
                     console.log('Product details seventh : ' + JSON.stringify(data));
                     ////console.log('Product details status : ' + status);
    ...
    /*
     * Method Name  - sendequiry
     * Created By   - vaibhav godambe
     * Created On   - 29 dec 2016
     * Modified By  -
     * Modified On  -
     * Purpose      - This method is used to move to send equiry page .
     */

    vm.sendequiry = function (itemid) {
    ...
    vm.CategoryProductSearch = function(itemid){
       ...
       // $cookies.remove("Categoryid");
        // Setting a cookie
        $cookies.put('Categoryid',itemid); //Set Categoryid
       // $rootScope.newCategoryid = itemid;
        vm.page = 0;
        vm.pagination(); //Call pagination method

    }


    /*
     * Method Name  - getfiltercategory
     * Created By   - vaibhav godambe
     * Created On   - 3 jan 2017
     * Modified By  -
     * Modified On  -
     * Purpose      - This method is used to get category vice filter onclick of filer check box button .
     */
     vm.getfiltercategory = function (item) {

         //console.log("category id  : " + item.categoryId);

         $cookies.put('Categoryid',item.categoryId); //Set Categoryid
    ...
    /*
     * Method Name  - searchByAlphabets
     * Created By   - vaibhav godambe
     * Created On   - 18 April 2017
     * Modified By  -
     * Modified On  -
     * Purpose      - This method is used to get product using alphabet .
     */
    vm.searchByAlphabets = function (aplhas) {

        //console.log("Alphabet : " + aplhas);

        $cookies.put('Alphabet',aplhas); //Set aplha
    ...
    /*
     * Method Name  - searchBydigit
     * Created By   - vaibhav godambe
     * Created On   - 18 April 2017
     * Modified By  -
     * Modified On  -
     * Purpose      - This method is used to get product using digit .
     */
    vm.searchBydigit = function (digit) {

        //console.log("Digit : " + digit);

        $cookies.put('Digit',digit); //Set digit
    ...
    /*
     * Method Name  - getfilterByComposition
     * Created By   - vaibhav godambe
     * Created On   - 13 April 2017
     * Modified By  -
     * Modified On  -
     * Purpose      - This method is used to get filter by composition .
     */
