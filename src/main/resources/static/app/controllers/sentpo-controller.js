myApp.controller('SentPooCtrl', function($scope,$rootScope,$route,baseURl,$location,$cookies,errorMessage,Page,$http,DTOptionsBuilder, DTColumnBuilder,sessionmaintain,sessionout,ContextPath) {
    var vm = $scope;
    ...
    Page.setTitle('Sent Purchase Order'); // To set Page Title using factory
    /*
    ...
    // Retrieving a cookie
    var SentPoId_Cookie = $cookies.get('SentPoId'); // get SentPoId cookies
    //console.log("SentPoId_Cookie : " +SentPoId_Cookie);
    ...
    // sent enq Tab
    $http.get(ContextPath +'/api/v1/purchaseOrders/'+ SentPoId_Cookie +'?projection=detail' , getquodtlsconfig)
        .success(function (data, status) {
            //console.log('Sent Purchase order details  : ' + JSON.stringify(data));
           //console.log('Sent Purchase order details status : ' + status);

            vm.POSentdata = data; // Received
           ...
           vm.shipmentby = data.shipmentBy;
            //console.log("Sent PO shipmentby : " +vm.shipmentby);
            //console.log("Sent PO typeof shipmentby" + typeof vm.shipmentby);
        ...
        .error(function (data, status) {
            ...
            //console.log("Sent Purchase order details Error Data : " +data);
            //console.log("Sent Purchase order details Error Status : " +status);
        });
