myApp.controller('ReportaboutCtrl', function($scope,$route,$rootScope,$location,$cookies,Page,baseURl,errorMessage,$http,sessionmaintain,getcategorydetails,ContextPath,$timeout){
  
    
    var vm = $scope;
    
    Page.setTitle('Report About & Take Down Policy'); // To set Page Title using factory
