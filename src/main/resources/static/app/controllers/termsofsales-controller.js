myApp.controller('TermsofsalesCtrl', function($scope,$route,$rootScope,$location,$cookies,Page,baseURl,errorMessage,$http,sessionmaintain,getcategorydetails,ContextPath,$timeout){
  
    
    var vm = $scope;
    
    Page.setTitle('Terms of Sales'); // To set Page Title using factory
