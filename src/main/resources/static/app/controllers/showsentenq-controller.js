myApp.controller('ShowSendEnqCtrl', function($scope,$rootScope,$route,baseURl,$location,$cookies,errorMessage,Page,$http,DTOptionsBuilder, DTColumnBuilder,sessionmaintain,sessionout,ContextPath,$filter) {
    var vm = $scope;
    ...
    Page.setTitle('Sent Enquiry details'); // To set Page Title using factory
    /*
    ...
    // Retrieving a cookie
    var SentEnqId_Cookie = $cookies.get('SentEnqId'); // get SentEnqId cookies
    //console.log("SentEnqId_Cookie : " +SentEnqId_Cookie);
    ...
    // Receiver enq Tab
    $http.get(ContextPath +'/api/v1/enquiries/'+ SentEnqId_Cookie +'?projection=detail' , getenqdtlsconfig)
        .success(function (data, status) {
           //console.log('Sent Enquires details  : ' + JSON.stringify(data));
          //console.log('Sent Enquires details status : ' + status);
           ...
           vm.sendenqShipBy = data.shipmentBy;
            //console.log("Show Sent Enquiry shipmentby : " +vm.sendenqShipBy);
            //console.log("Show Sent Enquiry typeof shipmentby" + typeof vm.sendenqShipBy);
           vm.msg = data.message;
    ...
    vm.channel = SentEnqId_Cookie + 'enq' ; // Unique channel Id
