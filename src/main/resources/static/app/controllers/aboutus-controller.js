myApp.controller('AboutusCtrl', function($scope,$route,$rootScope,$location,$cookies,$cookieStore,Page,baseURl,errorMessage,$http,sessionmaintain,getcategorydetails,ContextPath,$timeout){
